...
-   [karpathy-guidelines](https://github.com/swarmclawai/andrej-karpathy-skills)：将 Andrej Karpathy 的编码代理建议打包为可安装的跨代理技能，支持 Claude Code、Codex、Cursor、Gemini、OpenCode、OpenClaw 等
