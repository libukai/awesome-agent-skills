...
-   [SkillBoss](https://github.com/heeyo-life/skillboss-skills)：统一 100+ AI 服务的 Skills 集合，包括 LLMs（Claude、GPT、Gemini、DeepSeek）、图片生成（DALL-E、Midjourney、Flux）、视频（Runway、Kling）、语音（ElevenLabs）等。一个 API Key 访问所有服务，OpenAI 兼容。由 OpenAI Startup Fund 和 Amazon 支持。
...
本项目提供了多个实用插件，帮助你快速创建和改进 Agent Skills，以及使用各种工具进行开发。
...
在官方 skill-creator plugin 基础上，增加了 [《Claude Skill 完整构建指南》](docs/Claude-Skills-完全构建指南.md)中的最佳实践，构建了一个 Pro 版的 Plugin，帮助你快速创建和改进 Agent Skills。

**安装：** 选择安装 `agent-skills-toolkit` 插件
...
通过 tldraw Desktop 的 Local Canvas API 进行编程式绘图和图形操作，轻松创建流程图、架构图、思维导图等各种可视化内容。

**安装：** 选择安装 `tldraw-helper` 插件

**功能特性：**

- 📚 完整的 tldraw Canvas API 使用指南
- ⚡ 快捷命令：`/tldraw:draw`, `/tldraw:screenshot`, `/tldraw:list`, `/tldraw:clear`
...
详细文档请查看：[tldraw-helper README](.claude/plugins/tldraw-helper/README.md)
