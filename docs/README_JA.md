...
- [skillfold](https://github.com/byronxlg/skillfold)：マルチエージェント AI パイプラインの設定言語とコンパイラ。単一の YAML 設定を Claude Code、Cursor、Copilot、Gemini を含む 11 のプラットフォーム向けのエージェントスキルにコンパイル。再利用可能な 11 のライブラリスキルを同梱
