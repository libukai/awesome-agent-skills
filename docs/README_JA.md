...
-   [karpathy-guidelines](https://github.com/swarmclawai/andrej-karpathy-skills)：Andrej Karpathy に着想を得たコーディングエージェント向けガイドラインを、Claude Code、Codex、Cursor、Gemini、OpenCode、OpenClaw などで使えるインストール可能なクロスエージェント Skill として提供
